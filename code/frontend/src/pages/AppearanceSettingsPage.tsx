    ...
    >
      ...
      <div className="flex items-center gap-2.5 px-4 py-3 border-t bg-card">
        ...
        <div className="flex-1">
          ...
          <p className="text-[11px] text-muted-foreground tracking-wide">{tagline}</p>
        </div>
        {active && (
...
function ThemePreview({ variant }: { variant: "light" | "dark" }) {
  ...
  const sidebar = variant === "light" ? "#f4f4f5" : "#171717";
  const muted = variant === "light" ? "#e4e4e7" : "#27272a";
  const accent = variant === "light" ? "#18181b" : "#fafafa";
  const subtle = variant === "light" ? "#a1a1aa" : "#52525b";
  ...
  return (
    ...
    >
      ...
      >
        <div className="h-1.5 rounded-full" style={{ backgroundColor: accent, width: "60%" }} />
        <div className="h-1 rounded-full" style={{ backgroundColor: muted, width: "85%" }} />
        <div className="h-1 rounded-full" style={{ backgroundColor: muted, width: "70%" }} />
        <div className="h-1 rounded-full" style={{ backgroundColor: muted, width: "80%" }} />
      </div>
      {/* content */}
      <div className="absolute left-[28%] top-0 right-0 bottom-0 p-3 space-y-2">
        <div className="h-2 rounded-full" style={{ backgroundColor: accent, width: "45%" }} />
        <div className="h-1.5 rounded-full" style={{ backgroundColor: subtle, width: "70%" }} />
